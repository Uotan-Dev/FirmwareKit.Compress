    ...
    static class Katajainen
    {
        ...
        */
        class Node
        {
            ...
            public Node? tail;  /* Previous node(s) of this chain, or null if none. */
        ...
        */
        ...
        // Thread-local buffer pools so concurrent calls never interfere.
        [ThreadStatic] static Node[]? _nodes;
