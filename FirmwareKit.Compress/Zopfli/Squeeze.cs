...
namespace FirmwareKit.Compress.Internal.Zopfli
{
    internal partial class Compress
    {
        ...
        {
            Array.Clear(stats.litlens, 0, stats.litlens.Length);
            Array.Clear(stats.dists, 0, stats.dists.Length);
        }
        ...
        */
                             ...
                             ZopfliHash h, float[] costs, bool fixedcosts)
        {
            ...
            Polyfill.Fill(costs, (float)Compress.ZOPFLI_LARGE_FLOAT);
            ...
            ref float costs0 = ref Polyfill.GetArrayDataReference(costs);
            ref ushort la0 = ref Polyfill.GetArrayDataReference(length_array);
            ref double costLen0 = ref Polyfill.GetArrayDataReference(costLen);
            ref double costDist0 = ref Polyfill.GetArrayDataReference(costDist);
            ref ushort sublen0 = ref Polyfill.GetArrayDataReference(sublen);
